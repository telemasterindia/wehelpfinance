...
export const metadata: Metadata = {
  ...
  description: EXCERPT,
  alternates: { canonical: `https://www.wehelpfinance.com/collection-agency-rights` },
  openGraph: {
    title: TITLE,
    description: EXCERPT,
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbJsonLd([
        ...
        { name: "Collection Agency Rights", path: "https://www.wehelpfinance.com/collection-agency-rights" },
      ])) }} />
      <BlogPost
