...
export const metadata: Metadata = {
  ...
  description: EXCERPT,
  alternates: { canonical: "https://www.wehelpfinance.com/debt-settlement-vs-bankruptcy" },
  openGraph: { title: TITLE, description: EXCERPT, url: "https://www.wehelpfinance.com/debt-settlement-vs-bankruptcy", type: "article" },
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbJsonLd([
        ...
        { name: "Debt Settlement vs. Bankruptcy", path: "https://www.wehelpfinance.com/debt-settlement-vs-bankruptcy" },
      ])) }} />
