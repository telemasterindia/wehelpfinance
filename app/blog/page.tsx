...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Financial Education Blog | WeHelpFinance",
    description: "Research-backed articles on debt, tax relief, and personal finance.",
  },
};
...
const ARTICLES = [
  {
    ...
    excerpt: "Before you make the decision to stop paying, understand exactly what the timeline looks like — from the first missed payment to a potential lawsuit — and what your options are at every stage.",
  ...
  },
  {
    ...
    excerpt: "If you've been making minimum payments for years and your balance barely moves, you're not doing it wrong — the math is just designed to keep you paying interest indefinitely.",
    category: "Debt Relief",
    date: "2026-06-24",
    readingTime: 8,
    featured: true,
  },
  {
    ...
    excerpt: "Average credit card interest rates hit record highs in 2025–2026. Here's what that means for your balance and what practical steps you can take right now.",
    category: "Research",
    date: "2026-06-24",
    readingTime: 7,
    featured: false,
  },
  {
    ...
    excerpt: "Losing your income while carrying credit card debt is one of the most stressful financial situations Americans face right now. Here's a clear-headed guide to your options.",
    category: "Research",
    date: "2026-06-24",
    readingTime: 9,
    featured: false,
  },
  {
    ...
    excerpt: "Groceries, rent, insurance, and utilities have all risen faster than wages. For millions of middle-income Americans, credit cards became the gap-filler — and the debt accumulated fast.",
    category: "Research",
    date: "2026-06-24",
    readingTime: 8,
    featured: false,
  },
  {
    ...
    excerpt: "Millions of Americans search for government credit card forgiveness programs every month. Here's the truth about what exists, what doesn't, and what legitimate options are actually available.",
    category: "Debt Relief",
    date: "2026-06-24",
    readingTime: 7,
    featured: false,
  },
  {
    ...
    title: "The Subscription Debt Trap: How Digital Expenses Are Maxing Out America",
    excerpt: "The average American pays for over a dozen subscription services. Combined with rising costs elsewhere, this hidden drain on income is pushing more households into credit card debt.",
    category: "Research",
    date: "2026-06-24",
    readingTime: 7,
    featured: false,
  },
  {
    ...
    excerpt: "For many Americans — particularly those with religious values — the idea of paying less than what you owe feels morally wrong. This article addresses that concern honestly.",
    category: "Debt Relief",
    date: "2026-06-24",
    readingTime: 8,
    featured: false,
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-primary-soft/40 to-background">
        <div className="container-page max-w-4xl py-14 lg:py-20">
          ...
          <p className="mt-4 max-w-2xl text-lg text-muted-foreground">
            ...
            written to help Americans understand their financial options without pressure or jargon.
          </p>
        </div>
      </section>
      ...
      <div className="container-page max-w-5xl py-12">
        ...
        <section className="mt-14 rounded-3xl border border-border bg-card p-8 text-center">
          ...
          <p className="mt-2 text-muted-foreground text-sm">Explore by financial situation</p>
...
function ArticleCard({
  ...
  return (
    ...
    >
      ...
      <h3 className={`mt-3 font-display font-semibold text-foreground group-hover:text-primary leading-snug ${featured ? "text-xl" : "text-base"}`}>
        {article.title}
      </h3>
      ...
      <span className="mt-4 inline-flex items-center gap-1.5 text-xs font-semibold text-primary">
        Read article <ArrowRight className="h-3.5 w-3.5 transition group-hover:translate-x-1" aria-hidden="true" />
      </span>
    </Link>
  );
}
