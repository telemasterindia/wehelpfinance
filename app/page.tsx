...
export const metadata: Metadata = {
  ...
  description:
    "Making good money but still struggling with debt? WeHelpFinance connects you with trusted specialists for debt relief, tax relief, and personal loans. Free, confidential, no obligation.",
...
const FAQS: FAQItem[] = [
  {
    q: "What does WeHelpFinance do?",
    a: "We're a free matching service that connects everyday Americans with vetted financial specialists for debt relief, tax relief, and personal loans. We listen to your situation, then introduce you to a provider who fits your needs.",
  },
  {
    q: "Is WeHelpFinance a lender?",
    a: "No. WeHelpFinance is not a lender, bank, law firm, credit repair organization, or tax advisory firm. We connect you with independent providers who handle the actual services.",
  },
  {
    q: "What is debt relief?",
    a: "Debt relief is an umbrella term for programs that help reduce, restructure, or pay off unsecured debt — including debt settlement, consolidation, and management plans. The right option depends on your income, balances, and goals.",
  },
  {
    q: "How does debt settlement work?",
    a: "A specialist negotiates with your creditors to accept less than what you owe. You typically make deposits into a dedicated account until enough has accumulated to fund a negotiated settlement.",
  },
  {
    q: "Will this affect my credit?",
    a: "Some programs can impact your credit during the process; others are credit-neutral. Your specialist will walk you through the trade-offs honestly so you can decide what's right for you.",
  },
  {
    q: "How quickly will someone contact me?",
    a: "Most consultations are scheduled within one business day. You're never obligated to move forward — the call is free and judgment-free.",
  },
];
        ...
        <div className="container-page grid gap-10 pt-10 pb-16 lg:grid-cols-2 lg:items-center lg:gap-14 lg:pt-20 lg:pb-24">
          <div>
            <span className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1.5 text-xs font-medium text-primary">
              <Sparkles className="h-3.5 w-3.5" /> Trusted financial recovery,
              made human
            </span>
            <h1 className="mt-4 font-display text-3xl font-semibold tracking-tight sm:text-4xl">
              Debt Relief, Tax Relief &amp; Personal Loans — Free Help for
              Americans
            </h1>
            <h2 className="mt-4">
              Making good money but still{" "}
              <span className="italic text-primary">struggling with debt?</span>
            </h2>
            <p className="mt-5 max-w-xl text-lg text-muted-foreground">
              WeHelpFinance helps Americans explore debt relief, tax relief,
              personal loan, and financial recovery solutions through trusted
              specialists.
            </p>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              <a href="#how-it-works" className="btn-ghost-pill">
                How it works
              </a>
            </div>
          </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Specialists are standing by — judgment-free.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="container-page py-16">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            Every journey to financial relief starts with one honest
            conversation.
          </p>
        </div>
        ...
        <div className="container-page">
          ...
          <ol className="mx-auto mt-12 grid max-w-4xl gap-6 md:grid-cols-3">
            {[
              {
                n: "01",
                t: "Tell us about your situation",
                d: "Answer a few quick questions in under 2 minutes.",
              },
              {
                n: "02",
                t: "We review your options",
                d: "We match you with specialists suited to your needs.",
              },
              {
                n: "03",
                t: "Speak with a specialist",
                d: "Have a free, no-obligation conversation when it's right for you.",
              },
            ].map((s) => (
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
          <div>
            ...
            <p className="mt-4 max-w-md text-muted-foreground">
              Tell us a little about what you're facing. A specialist will reach
              ...
              {[
                {
                  Icon: Clock,
                  t: "Fast response",
                  d: "Most callbacks within one business day.",
                },
                {
                  Icon: Lock,
                  t: "Secure & confidential",
                  d: "Your information is never sold.",
                },
                {
                  Icon: HeartHandshake,
                  t: "No obligation",
                  d: "Decide on your own timeline — no pressure.",
                },
                {
                  Icon: ShieldCheck,
                  t: "Experienced specialists",
                  d: "Vetted partners with deep industry experience.",
                },
              ].map(({ Icon, t, d }) => (
      ...
      <section className="container-page pb-24">
        <div className="rounded-3xl bg-primary px-6 py-12 text-center text-primary-foreground sm:px-12">
          ...
          <p className="mx-auto mt-3 max-w-xl text-primary-foreground/85">
            A short conversation can open the door to real options. It's free,
...
function CategoryCard({
  ...
  return (
    <div className="group flex flex-col rounded-3xl border border-border bg-card p-7 transition hover:-translate-y-1 hover:border-primary/40 hover:shadow-xl">
      ...
      <p className="mt-4 flex-1 font-display text-xl text-foreground">
        {title}
      </p>
      <Link
        href={href}
