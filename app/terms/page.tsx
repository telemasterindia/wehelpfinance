      ...
      <article className="container-page mx-auto max-w-3xl py-14">
        ...
        <div className="mt-8 space-y-6 text-[15px] leading-relaxed text-foreground">
          <p>
            ...
            wehelpfinance.com (the "Site"). By accessing or using the Site, you
            agree to be bound by these Terms.
          </p>

          <h2 className="text-2xl">Nature of our service</h2>
          <p>
            WeHelpFinance is a free matching and referral service. We are{" "}
            <strong>not</strong> a lender, bank, law firm, credit repair
            organization, debt settlement company, or tax advisory firm. We
            connect consumers with independent third-party financial service
            providers ("Partners") who handle the actual services.
          </p>

          <h2 className="text-2xl">No guarantees</h2>
          <p>
            We do not guarantee any specific outcome, savings, approval, loan
            amount, interest rate, or tax resolution. Results vary by individual
            circumstances and depend on Partner evaluations and decisions.
          </p>

          <h2 className="text-2xl">Eligibility</h2>
          <p>
            You must be at least 18 years old and a U.S. resident to use the
            Site. By submitting information, you represent that the information
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>
              You authorize WeHelpFinance and Partners to contact you per our
              Privacy Policy.
            </li>
          </ul>
          ...
          <p>
            All content, branding, and design on the Site are owned by
            WeHelpFinance or its licensors and are protected by applicable laws.
          </p>

          <h2 className="text-2xl">Disclaimer of warranties</h2>
          <p>
            The Site and any information provided are offered "as is" and "as
          ...
          <p>
            To the fullest extent permitted by law, WeHelpFinance and its
            ...
            data arising from your use of the Site or any Partner services.
          </p>

          <h2 className="text-2xl">Governing law</h2>
          <p>
            These Terms are governed by the laws of the United States and the
            state in which WeHelpFinance is organized, without regard to
