      ...
      <section className="container-page py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            A trusted specialist will reach out within one business day. Keep an eye on your phone and email.
          </p>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2">
            <div className="surface-card text-left">
              ...
              <p className="mt-2 text-sm text-muted-foreground">Calls typically come from a local or toll-free number. No obligation to proceed.</p>
            </div>
            <div className="surface-card text-left">
              <div className="flex items-center gap-3">
              ...
              <p className="mt-2 text-sm text-muted-foreground">Check your inbox (and spam folder) for a follow-up with next steps.</p>
            </div>
          </div>
